...
function CheckoutSection() {
  ...
  let [formdata,setformdata]=useState({country:"india", firstname:"ashish",lastname:"yadav",companyname:"xyz",address:"gurugram",state:"haryana",zip:"122301", email:"ashishj@gmail.com",phoneno :"122335313234",})
            ...
            <div className="col-md-6 mb-5 mb-md-0">
              ...
              <div className="p-3 p-lg-5 border bg-white">
                <div className="form-group">
                  ...
                  <select id="c_country" className="form-control" value = {formdata ["country"]} name = "country">
